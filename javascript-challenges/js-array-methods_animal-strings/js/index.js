...
const firstAnimalStartingWithLetterP = animalStrings.find((animal) => animal.startWith("p"));
...
const anyAnimalEndsWithLetterZ animalStrings.some((animal) => animalStrings.endsWith("z"));
...
const sumOfAllAnimalCharacters = animalStrings.map((animal) => animal.length) .reduce((acc, num) => acc + num, 0);
